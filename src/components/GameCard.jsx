...
const GameCard = ({ image, name, description }) => {
  ...
  return (
    <>
        ...
        <div class="h-full w-full">
          ...
          <div class="mb-3 flex items-center justify-between px-1 md:items-start">
            <div class="mb-2">
              ...
              <p class="mt-1 text-sm font-medium text-gray-600 md:mt-2">{description}</p>
            </div>
      ...
      <p class="font-normal text-navy-700 mt-20 mx-auto w-max">Notifications Card component from <a href="https://horizon-ui.com?ref=tailwindcomponents.com" target="_blank" rel="noreferrer" class="text-brand-500 font-bold">Horizon UI Tailwind React</a></p>  
      </>
  );
}
